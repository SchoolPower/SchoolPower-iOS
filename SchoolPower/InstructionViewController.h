...
@interface InstructionViewController : UIViewController <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate, OnboardingContentViewControllerDelegate>
    ...
    /**
     * @brief A block that will be executed when the ok button is pressed.
     */
    @property (nonatomic, strong) dispatch_block_t okHandler;
    ...
    /**
     * @brief The ok button that allows users to finish onboarding at the end.
     */
     ...
     * @return An instance of InstructionViewController with the provided background image and content view controllers.
     */
+ (instancetype)onboardWithBackgroundImage:(UIImage *)backgroundImage contents:(NSArray *)contents;
     ...
     * @return An instance of InstructionViewController with the provided background video and content view controllers.
     */
