...
typedef void (^action_callback)(InstructionViewController *onboardController);


@interface OnboardingContentViewController : UIViewController

@property (nonatomic, weak) InstructionViewController<OnboardingContentViewControllerDelegate> *delegate;
 ...
 * @return An instance of InstructionViewController with the provided information.
 */
