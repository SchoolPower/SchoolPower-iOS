...
static CGFloat const kSkipButtonHeight = 50;
...
//    [self.okButton addTarget:self action:@selector(handleOkButtonPressed) forControlEvents:UIControlEventTouchUpInside];
...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *backButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"baseline_close_white_24pt"] style:UIBarButtonItemStylePlain target:self action:@selector(backButtonPressed:)];
...
- (void)viewWillLayoutSubviews {
    ...
    self.skipButton.frame = CGRectMake(16, CGRectGetMaxY(self.view.frame) - safedUnderPageControlPadding - kSkipButtonHeight, kSkipButtonWidth, kSkipButtonHeight);
    self.okButton.frame = CGRectMake(CGRectGetMaxX(self.view.frame) - kSkipButtonWidth - 16, CGRectGetMaxY(self.view.frame) - safedUnderPageControlPadding - kSkipButtonHeight, kSkipButtonWidth, kSkipButtonHeight);
    self.pageControl.frame = CGRectMake(0, CGRectGetMaxY(self.view.frame) - safedUnderPageControlPadding - kPageControlHeight - 8, self.view.frame.size.width, kPageControlHeight);
    //CGRectGetMaxX(self.view.frame) - kSkipButtonWidth - 16
}
...
//    NSLog(@"ndfijhbnxrfidljkbhnfdm jhbfdkijhgfnikx drjfnbikfgjnkcfljbnfg");
//}
//
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (transitioningToLastPage) {
        self.okButton.alpha = percentComplete;
    }
    
    else if (transitioningFromLastPage) {
        self.okButton.alpha = percentCompleteInverse;
    }
